...
public class SimpleGateway extends AbstractGateway {
    ...
    private static final String TAG = "SimpleGateway";
    ...
    public SimpleGateway(Context mContext, SubDevicesPersistence subDevicesPersistence, String serverUri, String deviceId, String deviceSecret) {
        super(mContext, subDevicesPersistence, serverUri, deviceId, deviceSecret);
    ...
    public void removeSession(String channelId) {
        ...
        Log.i(TAG, "session removed " + session.toString());
    }
    ...
    public Session createSession(String nodeId, Channel channel) {
        ...
        if (subdev != null) {
            ...
            Log.i(TAG, "create new session ok" + session.toString());
            return session;
        }

        Log.i(TAG, "not allowed : " + nodeId);
        return null;
    }
